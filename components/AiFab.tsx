...
export const AiFab: React.FC<AiFabProps> = ({ setCurrentPage }) => (
  <button 
    ...
    className="fixed bottom-4 right-4 w-14 h-14 bg-teal-700 text-white rounded-full flex items-center justify-center shadow-xl hover:bg-teal-800 focus:outline-none focus:ring-4 focus:ring-teal-300 transition-all transform hover:scale-105"
